...
public class DashboardPage extends CommonPage {
    ...
    public void verifyInvoicesAwaitingPayment(){
        ...
        Assert.assertEquals(driver.findElement(totalInvoicesAwaitingPayment).getText(),"0 / 2","Failed - The Invoices Awaiting Payment the same value");
    }
    public void verifyTotalConvertedLeads(){
        ...
        Assert.assertEquals(driver.findElement(totalConvertedLeads).getText(),"0 / 0","Failed - The Converted Leads not the same value");
    }
    public void verifyTotalProjectsInProgress(){
        ...
        Assert.assertEquals(driver.findElement(totalProjectsInProgress).getText(),"55 / 59","Failed - The Projects In Progress not the same value");
    }
    public void verifyTotalTasksNotFinished(){
        ...
        Assert.assertEquals(driver.findElement(totalTasksNotFinished).getText(),"76 / 76","Failed - The Tasks Not Finished not the same value");
    }
