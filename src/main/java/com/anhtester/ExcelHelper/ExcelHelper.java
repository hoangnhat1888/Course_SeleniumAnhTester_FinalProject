package com.anhtester.ExcelHelper;
...
public class ExcelHelper {
    ...
    //Khai bao Excel File & Identify SheetName
    ...
    //Gọi ra hàm này dung cho ro~ rang'(DA HINH VOI FUCN TREN - 2 HAMM GIONG NHAU)
    ...
    public void setCellData(String text, String columnName, int rowIndex) {
        try {
            ...
            fileOut.flush();
            fileOut.close();
            LogUtils.info("Successfully Set data");
        } catch (Exception e) {
            LogUtils.error(e.getMessage());
        }
    }

    // Get  entire the data from Sheet
